    ...
    <section id="application" className="py-20 px-4 bg-[#140f0b]/50">
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="bg-[#140f0b] border-[hsl(215_18%_20%)]">
            <CardHeader>
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-3 py-2 bg-[#1f120d] border border-[hsl(215_18%_20%)] rounded-md text-white focus:outline-none focus:ring-2 focus:ring-[#fa5d3d] font-inter transition-all duration-300 hover:border-[#fa5d3d] focus:shadow-[0_0_30px_rgba(250,93,61,0.2)]"
              ...
              <div>
                ...
                <textarea
                  rows={4}
                  className="w-full px-3 py-2 bg-[#1f120d] border border-[hsl(215_18%_20%)] rounded-md text-white focus:outline-none focus:ring-2 focus:ring-[#fa5d3d]"
              ...
              <div className="flex justify-center">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-[#fa5d3d] to-[#ff8c73] hover:from-[#ff8c73] hover:to-[#fa5d3d] text-lg px-8 py-3 font-inter font-semibold tracking-wide hover:shadow-[0_0_30px_rgba(250,93,61,0.35)] transition-all duration-300 hover:scale-105"
                >
