...
export default function AvailableJobs({ t }: { t: any }) {
  ...
  return (
    <section id="available-jobs" className="py-20 px-4 bg-[#0D0802]">
      <div className="container mx-auto">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {privateJobs.map((job) => (
              <div key={job.key} className={`group relative bg-[#120C04] rounded-xl border border-[#2A1E0A] p-6 transition-all duration-300 hover:-translate-y-1 ${job.border} ${job.shadow}`}>
