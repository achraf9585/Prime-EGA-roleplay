...
export default function Features({ t }: { t: any }) {
  return (
    <section id="features" className="py-20 px-4 bg-[#140f0b]/50">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="bg-[#140f0b] border-[hsl(215_18%_20%)] hover:border-[#fa5d3d] transition-all duration-300 hover:shadow-[0_0_30px_rgba(250,93,61,0.2)] hover:scale-105">
            <CardHeader>
              <Users className="h-12 w-12 text-[#fa5d3d] mb-4" />
          ...
          <Card className="bg-[#140f0b] border-[hsl(215_18%_20%)] hover:border-[#fa5d3d] transition-all duration-300 hover:shadow-[0_0_30px_rgba(250,93,61,0.2)] hover:scale-105">
            <CardHeader>
              <Shield className="h-12 w-12 text-[#fa5d3d] mb-4" />
          ...
          <Card className="bg-[#140f0b] border-[hsl(215_18%_20%)] hover:border-[#fa5d3d] transition-all duration-300 hover:shadow-[0_0_30px_rgba(250,93,61,0.2)] hover:scale-105">
            <CardHeader>
              <Car className="h-12 w-12 text-[#fa5d3d] mb-4" />
          ...
          <Card className="bg-[#140f0b] border-[hsl(215_18%_20%)] hover:border-[#fa5d3d] transition-all duration-300 hover:shadow-[0_0_30px_rgba(250,93,61,0.2)] hover:scale-105">
            <CardHeader>
              <HomeIcon className="h-12 w-12 text-[#fa5d3d] mb-4" />
          ...
          <Card className="bg-[#140f0b] border-[hsl(215_18%_20%)] hover:border-[#fa5d3d] transition-all duration-300 hover:shadow-[0_0_30px_rgba(250,93,61,0.2)] hover:scale-105">
            <CardHeader>
              <Briefcase className="h-12 w-12 text-[#fa5d3d] mb-4" />
          ...
          <Card className="bg-[#140f0b] border-[hsl(215_18%_20%)] hover:border-[#fa5d3d] transition-all duration-300 hover:shadow-[0_0_30px_rgba(250,93,61,0.2)] hover:scale-105">
            <CardHeader>
              <Heart className="h-12 w-12 text-[#fa5d3d] mb-4" />
